library dartapp.web.main.generated_static_injector;
...
import 'package:dartapp/dart_controller.dart' as import_16;
import 'package:dartapp/bigarticle/bigarticle_component.dart' as import_17;
...
final Map<Type, TypeFactory> factories = <Type, TypeFactory>{
  ...
  import_16.DartController: (f) => new import_16.DartController(),
  import_17.BigArticleComponent: (f) => new import_17.BigArticleComponent(),
