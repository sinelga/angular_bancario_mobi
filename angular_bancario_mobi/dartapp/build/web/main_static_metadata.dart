library dartapp.web.main.generated_metadata;
...
final Map<Type, Object> typeAnnotations = {
  ...
  import_6.BigArticleComponent: const [
    const import_1.Component(selector: 'bigarticle', templateUrl: 'packages/dartapp/bigarticle/bigarticle_component.html', applyAuthorStyles: true, publishAs: 'cmp', map: const {'articelobj': '=>articelobj'}),
  ],
};
